...
/*== This is a complete rehaul of my insertX ==*/

void insertX(char (&TTTarray)[3][3], int counter)
	/*=== This will always be the first move ===*/
	//X is in the center of the board.
	if (TTTarray[1][1] == '-' && counter == 0){
		TTTarray[1][1] = 'X';//counter is now 1
	}
	/*
if (TTTarray[0][0]=='-' && TTTarray[0][1]=='-' && TTTarray[0][2]=='-' && TTTarray[1][0]=='-' && TTTarray[1][2]=='-' && TTTarray[2][0]=='-' && TTTarray[2][1]=='-' && TTTarray[2][2]=='-'){
	...
	*/
	...
	if (counter == 2){
if (TTTarray[0][0]=='O' && TTTarray[0][1]=='-' && TTTarray[0][2]=='-' && TTTarray[1][0]=='-' && TTTarray[1][2]=='-' && TTTarray[2][0]=='-' && TTTarray[2][1]=='-' && TTTarray[2][2]=='-'){
	TTTarray[2][2] = 'X';
}
if (TTTarray[0][0]=='-' && TTTarray[0][1]=='O' && TTTarray[0][2]=='-' && TTTarray[1][0]=='-' && TTTarray[1][2]=='-' && TTTarray[2][0]=='-' && TTTarray[2][1]=='-' && TTTarray[2][2]=='-'){
	TTTarray[2][0] = 'X';
}
if (TTTarray[0][0]=='-' && TTTarray[0][1]=='-' && TTTarray[0][2]=='O' && TTTarray[1][0]=='-' && TTTarray[1][2]=='-' && TTTarray[2][0]=='-' && TTTarray[2][1]=='-' && TTTarray[2][2]=='-'){
	TTTarray[2][0] = 'X';
}
if (TTTarray[0][0]=='-' && TTTarray[0][1]=='-' && TTTarray[0][2]=='-' && TTTarray[1][0]=='O' && TTTarray[1][2]=='-' && TTTarray[2][0]=='-' && TTTarray[2][1]=='-' && TTTarray[2][2]=='-'){
	TTTarray[2][2] = 'X';
}
if (TTTarray[0][0]=='-' && TTTarray[0][1]=='-' && TTTarray[0][2]=='-' && TTTarray[1][0]=='-' && TTTarray[1][2]=='O' && TTTarray[2][0]=='-' && TTTarray[2][1]=='-' && TTTarray[2][2]=='-'){
	TTTarray[0][0] = 'X';
}
if (TTTarray[0][0]=='-' && TTTarray[0][1]=='-' && TTTarray[0][2]=='-' && TTTarray[1][0]=='-' && TTTarray[1][2]=='-' && TTTarray[2][0]=='O' && TTTarray[2][1]=='-' && TTTarray[2][2]=='-'){
	TTTarray[0][2] = 'X';
}
if (TTTarray[0][0]=='-' && TTTarray[0][1]=='-' && TTTarray[0][2]=='-' && TTTarray[1][0]=='-' && TTTarray[1][2]=='-' && TTTarray[2][0]=='-' && TTTarray[2][1]=='O' && TTTarray[2][2]=='-'){
	TTTarray[0][0] = 'X';
}
if (TTTarray[0][0]=='-' && TTTarray[0][1]=='-' && TTTarray[0][2]=='-' && TTTarray[1][0]=='-' && TTTarray[1][2]=='-' && TTTarray[2][0]=='-' && TTTarray[2][1]=='-' && TTTarray[2][2]=='O'){
	TTTarray[0][0] = 'X';
}
	}//end of counter 2

	if (counter == 4){
if (TTTarray[0][0]=='O' && TTTarray[0][1]=='-' && TTTarray[0][2]=='O' && TTTarray[1][0]=='-' && TTTarray[1][2]=='-' && TTTarray[2][0]=='-' && TTTarray[2][1]=='-' && TTTarray[2][2]=='X'){
	TTTarray[0][1] = 'X';
}
if (TTTarray[0][0]=='O' && TTTarray[0][1]=='-' && TTTarray[0][2]=='-' && TTTarray[1][0]=='-' && TTTarray[1][2]=='-' && TTTarray[2][0]=='O' && TTTarray[2][1]=='-' && TTTarray[2][2]=='X'){
	TTTarray[1][0] = 'X';
}
if (TTTarray[0][0]=='-' && TTTarray[0][1]=='O' && TTTarray[0][2]=='-' && TTTarray[1][0]=='-' && TTTarray[1][2]=='-' && TTTarray[2][0]=='X' && TTTarray[2][1]=='-' && TTTarray[2][2]=='-'){
...
if (TTTarray[0][0]=='-' && TTTarray[0][1]=='-' && TTTarray[0][2]=='-' && TTTarray[1][0]=='-' && TTTarray[1][2]=='-' && TTTarray[2][0]=='-' && TTTarray[2][1]=='-' && TTTarray[2][2]=='-'){
	...
	if (TTTarray[1][1] == 'O' && counter == 2){	/*=== moveCounter's count should be 2 ===*/
		TTTarray[2][2] = 'X';	/*== Count should be 3 ==*/
		/*=== O's second move is a middle side ===*/
		if (TTTarray[0][1] == 'O' && counter ==4){ /* Count should be 4 */
