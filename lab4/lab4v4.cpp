...
/* So once O places his first character in a corner position, Ducky will remember that O placed one there and will use a strategy based off of O's first position */
